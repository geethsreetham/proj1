...
function Featmancar() {
  const cards = [
    ...
    },
    {
      ...
      description: "The path to the martial peak is a lonely and solitary one...",
      img: "https://i.ibb.co/Sm0ZsYR/manga-thumbnail.jpg"
    },
    {
      title: "Solo Leveling",
      ...
      description: "Sung Jin-Woo, the world's weakest hunter, awakens a hidden power within...",
      img: "https://i.ibb.co/Sm0ZsYR/manga-thumbnail.jpg"
    },
    {
      title: "Solo Leveling",
      ...
      >
        {cards.map((card, index) => (
          <SwiperSlide key={index}>
            <div className="card text-white bg-gradient p-4 shadow-lg rounded" style={{ backgroundColor: '#2c2c54' }}>
              <div className="row g-0 align-items-center">
                <div className="col-md-4">
                  <img src={card.img} className="img-fluid rounded" alt="cover" style={{ maxHeight: '150px', objectFit: 'cover' }} />
                </div>
